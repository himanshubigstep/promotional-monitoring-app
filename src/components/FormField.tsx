    ...
    return (
      <Box className={props.className}>
        ...
        >
          <Select
            ...
            sx={{
              ...
              "& .MuiOutlinedInput-notchedOutline": {
                borderColor: error ? "#fa3b1d" : "#cbd0dd",
              },
          ...
          {helperText && (
            <FormHelperText sx={{ color: error ? "#fa3b1d" : "#525b75" }}>
              {helperText}
            </FormHelperText>
          )}
        </FormControl>
